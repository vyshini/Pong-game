...
def save():
    ...
    if len(website) == 0 or len(password) == 0:
        messagebox.showinfo(title = "Oops",message = "Please make sure you have not left any empty fields.")
    else:
...
email_entry.insert(0,"vysh@gmail.com")
...
generate_password_button = Button(text = 'Generate Password',width = 30,command = generatePassword)
